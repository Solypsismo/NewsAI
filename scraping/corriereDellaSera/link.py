...
LINK = "https://sitesearch.corriere.it/forward.jsp?q=intelligenza%20artificiale#"
FILE_LINK = "corriereDellaSera/links.csv"
FILE_NUOVILINK = "corriereDellaSera/nuovi_link.csv"
...
div_notizie = zuppa.find("div", class_ = "ricerca-web")

h1_notizie = div_notizie.find_all("h1")
listaLinks = []

for h1 in h1_notizie:
    a_notizia = h1.find("a")
...
if is_csv_empty(FILE_LINK):
    ...
    df.to_csv(FILE_LINK, index= False, header=False, mode="a", sep="\t", encoding='utf-8')    
    df.to_csv(FILE_NUOVILINK, index= False, mode="a", sep="\t", encoding='utf-8') 
